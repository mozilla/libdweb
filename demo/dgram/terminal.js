...
const execute = async state => {
  ...
  try {
    ...
    switch (command) {
      ...
      case "close": {
        await browser.UDPSocket.close(toSocket(params))
      ...
      case "send": {
        ...
        await browser.UDPSocket.send(toSocket(params), host, port, buffer, size)
        out.textContent = `sent`
        break
      }
      case "setMulticastLoopback": {
        const { flag } = params
        await browser.UDPSocket.setMulticastLoopback(toSocket(params), flag)
      ...
      case "setMulticastInterface": {
        ...
        await browser.UDPSocket.setMulticastInterface(
          toSocket(params),
          multicastInterface
        )
      ...
      case "addMembership": {
        ...
        await browser.UDPSocket.addMembership(
          toSocket(params),
          address,
          multicastInterface
        )
      ...
      case "dropMembership": {
        ...
        await browser.UDPSocket.dropMembership(
          toSocket(params),
          address,
          multicastInterface
        )
